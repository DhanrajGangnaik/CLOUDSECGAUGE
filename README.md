...
**Cloud Security Gauge** is a robust tool designed to detect and prevent SQL injections and other security vulnerabilities in cloud-hosted applications. Built with Flask and integrated with Oracle Database, this tool is ideal for developers and security professionals looking to enhance the security of their cloud applications.
...
- 🗄️ **Oracle Database Integration**: Connects securely with Oracle databases in a Dockerized container environment.
...
├── instantclient_23_5/       # Oracle Instant Client files
...
1. Build the Docker image:
   ```bash
   docker build -t cloudsecgauge .
   ```

2. Run the Docker container:
   ```bash
   docker run -d -p 5000:5000 --name cloudsecgauge_container cloudsecgauge
   ```
...
### Step 2: Configure the Oracle Instant Client

📥 Download and place the **Oracle Instant Client** files in the `instantclient_23_5` folder, as they are required for cx_Oracle to connect to the Oracle database.
